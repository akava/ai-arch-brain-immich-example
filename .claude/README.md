...
- `agents/` — the nine architecture agents (synthesis-agent, component-spec-agent, decision-record-agent, nfr-analysis-agent, integration-contract-agent, risk-assessment-agent, fitness-review-agent, handoff-agent, librarian-agent), each running in its own context window
