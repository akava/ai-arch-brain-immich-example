...
| Identity & access control plane (baseline §1.6) | **Immich Runtime Owner** (demo role) | Interim architect ruling 2026-07-12 (auth control plane lives in the server container + immich-admin CLI); pending client confirmation; routes R-07/R-08/R-09. |
| Fleet observability & health plane (E-05) | **Hosting Platform Lead** (demo role) | Interim architect ruling 2026-07-12; platform-side operability; pending client confirmation. |
| Customer onboarding pipeline & staging (E-06) | **Hosting Platform Lead** (demo role) | Interim architect ruling 2026-07-12; platform-side operability; pending client confirmation. |
